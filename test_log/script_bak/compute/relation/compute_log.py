...
script = '{base_dir}/var/compute_collect_log.sh'.format(base_dir=base_dir)
openstack_lst = ['/var/log/ceph','/var/log/libvirt/qemu/','/var/log/cinder','/var/log/nova','/var/log/neutron']
