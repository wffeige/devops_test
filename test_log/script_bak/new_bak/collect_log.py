...
#控制节点需要查询的日志目录
controller_openstack_lst =['/var/log/keystone', '/var/log/ceph', '/var/log/glance', '/var/log/cinder', '/var/log/nova', '/var/log/neutron']
...
# compute_openstack_lst = ['/var/log/nova']
#

# '/var/log/neutron','/var/log/libvirt/qemu'
